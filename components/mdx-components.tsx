...
export const mdxComponents: MDXComponents = {
  h2: (props) => (
    <h2
      className="font-headline text-(length:--font-size-h2) font-medium text-ink mt-ed-xl mb-ed-md"
      {...props}
    />
  ),
  h3: (props) => (
    <h3
      className="font-headline text-(length:--font-size-h3) font-semibold text-ink mt-ed-lg mb-ed-sm"
      {...props}
    />
  ),
  p: (props) => (
