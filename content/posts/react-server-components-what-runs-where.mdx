...
banner: "/banners/react-server-components-what-runs-where.png"
bannerAlt: "Editorial illustration of a server rack's data flowing as a tree of connected nodes across a divide into a browser window, representing the Server Component to Client Component boundary."
---
